...
"18": """King Nithuth gave to his daughter Bothvild the gold ring that he had taken from the bast rope in Völund's house, and he himself wore the sword that Völund had had. The queen spake:
...
was near the mainland, and was called Sævarstath. There he smithied for the king all kinds
of precious things. No man dared to go to him, save only the king himself.""",
...
kvánar, ef hánum koma gerði.""",

"6": """Þat spyrr Níðuðr, Níára dróttinn,
at einn Völundr sat í Ulfdölum;
nóttum fóru seggir, neglðar váru brynjur,
skildir bliku þeira við inn skarða mána.""",

"7": """Stigu ór söðlum at salar gafli,
gengu inn þaðan endlangan sal;
sáu þeir á bast bauga dregna,
sjau hundruð allra, er sá seggr átti.""",

"8": """Og þeir af tóku ok þeir á létu,
...
viðr inn vindþurri, fyr Völundi.""",

"10": """Sat á berfjalli, bauga talði,
alfa ljóði, eins saknaði;
hugði hann, at hefði Hlöðvés dóttir,
Alvitr unga, væri hon aftr komin.""",

"11": """Sat hann svá lengi, at hann sofnaði,
ok hann vaknaði viljalauss;
vissi sér á höndum höfgar nauðir,
en á fótum fjötur of spenntan.""",

"12": """\"Hverir ro jöfrar, þeir er á lögðu
besti bör síma ok mik bundu?\"""",

"13": """Kallaði nú Níðuðr Níara dróttinn:
"Hvar gaztu, Völundr, vísi alfa,
vára aura í Ulfdölum?\"""",

"14": """\"Völundr Kvað:
Gull var þar eigi á Grana leiðu,
fjarri hugða ek várt land fjöllum Rínar;
man ek, at vér meiri mæti áttum,
er vér heil hjú heima várum.""",

"15": """Hlaðguðr ok Hervör borin var Hlöðvé
kunn var Ölrún Kíárs dóttir.\"""",

"16": """[Úti stóð kunnig kván Níðaðar],
hon inn of gekk endlangan sal,
stóð á golfi, stillti röddu:
"Er-a sá nú hýrr, er ór holti ferr.\"""",

"17": """Níðuðr konungr gaf dóttur sinni, Böðvildi gullhring þann, er hann tók af bastinu at Völundar, en hann sjálfr bar sverðit, er Völundr átti. En dróttning kvað:
\"Ámun eru augu ormi þeim inum frána,
tenn hánum teygjask, er hánum er tét sverð
ok hann Böðvildar baug of þekkir;
sníðið ér hann sina magni
ok setið hann síðan í Sævarstöð.\"""",

"18": """Svá var gert, at skornar váru sinar í knésfótum, ok settr í hólm einn, er þar var fyrir landi, er hét Sævarstaðr. Þar smíðaði hann konungi alls kyns görsimar. Engi maðr þorði at fara til hans nema konungr einn.
...
sékk-a ek þann Völundi til smiðju borinn.""",

"19": """Nú berr Böðvildr brúðar minnar
- bíðk-a ek þess bót, -
bauga rauða.\"""",
...
synir Níðaðar, í Sævarstöð.""",

"21": """Kómu þeir til kistu, kröfðu lukla,
opin var illúð er þeir í sáu;
fjölð var þar menja, er þeim mögum sýndisk
at væri gull rautt ok görsimar.""",

"22": """Völundr kvað:
\"Komið einir tveir, komið annars dags;
ykkr læt ek þat gull of gefit verða;
segið-a meyjum né salþjóðum,
manni engum, at it mik fyndið.\"""",

"23": """Snemma kallaði seggr annan,
bróðir á bróður:
"Göngum baug séa!"
Kómu til kistu, kröfðu lukla,
opin var illúð, er þeir í litu.""",

"24": """Sneið af höfuð húna þeira
ok und fen fjöturs fætr of lagði;
en þær skálar, er und skörum váru,
sveip hann útan silfri, seldi Níðaði.""",

"25": """En ór augum jarknasteina
sendi hann kunnigri konu Níðaðar,
en ór tönnum tveggja þeira
...
kell mik í höfuð, köld eru mér ráð þín,
vilnumk ek þess nú, at ek við Völund dæma.""",

"32": """Seg þú mér þat, Völundr, vísi alfa,
af heilum hvat varð húnum mínum.\"""",

"33": """Völundr kvað:
\"Eiða skaltu mér áðr alla vinna,
at skips borði ok at skjaldar rönd,
at mars bægi ok at mækis egg,
at þú kvelj-at kván Völundar
né brúði minni at bana verðir,
þótt vér kván eigim, þá er ér kunnið,
eða jóð eigim innan hallar.""",

"34": """Gakk þú til smiðju, þeirar er þú gerðir,
þar fiðr þú belgi blóði stokkna;
sneið ek af höfuð húna þinna,
ok und fen fjöturs fætr of lagðak.""",

"35": """En þær skálar, er und skörum váru,
